...
A Wii U Aroma plugin that patches a TVii config file with a custom one from your SD card to redirect it's urls to a custom service.
...
# Note
Not every website will work with TVii. Most websites may have certificates that the Wii U will not like and prevent loading them.

# Credits 
- [Fangal-Airbag](https://github.com/Fangal-Airbag)
- [Novaur, aka literally2084 (formerly darcellapy)](https://github.com/literally2084)
